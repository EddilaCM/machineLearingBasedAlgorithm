...
public class SimpleTool {
	...
	public static void printTriple(Triple paraTriple) {
		System.out.println("user: " + paraTriple.i + " item: " + paraTriple.j + " rate: " + paraTriple.rate +
				" userGroupID: " + paraTriple.userGrp + " userGroupPosition: " + paraTriple.userGrpPos + 
				" itemGroupID: " + paraTriple.itemGrp + " itemGroupPosition: " + paraTriple.itemGrpPos);
	}// Of printTriple
	...
	public static void printTriple(Triple[] paraTriple) {
		for(int i = 0; i < paraTriple.length; i ++){
			System.out.println("user: " + paraTriple[i].i + " item: " + paraTriple[i].j + " rate: " + paraTriple[i].rate +
					" userGroupID: " + paraTriple[i].userGrp + " userGroupPosition: " + paraTriple[i].userGrpPos + 
					" itemGroupID: " + paraTriple[i].itemGrp + " itemGroupPosition: " + paraTriple[i].itemGrpPos);
		}//Of for i
