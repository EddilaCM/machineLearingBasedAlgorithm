...
/*小M想要宴请n个客人，她为他们准备了n个不同口味的披萨，分别盛装在n个大盘子中。但是由于她不知道每位客人喜欢什么口味，所以她希望每位客人都能品尝到这n种不同口味的披萨。
 * 于是她将每个披萨都均分成了n片，现在她想把这些分开后的披萨重组成n个包含n种不同口味的披萨。为此她取来了一个空的小盘子，小盘子只能容纳一片披萨。小M可以进行如下操作：
